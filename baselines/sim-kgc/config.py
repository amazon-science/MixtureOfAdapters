...
# default parameters uses same as train_wn.sh, except epochs
...
parser.add_argument('--model-dir', default='./checkpoint/temp', type=str, metavar='N',
...
parser.add_argument('--use-self-negative', action='store_true', default=False,
...
# Tri-encoder Model args
parser.add_argument('--model_name_or_path', type=str, default="bert-base-uncased")
parser.add_argument('--encoding_type', type=str, default="tri_encoder")
parser.add_argument('--freeze_encoder', action='store_true', default=False)

parser.add_argument('--objective', type=str, default='triplet_cl_mse')
parser.add_argument('--cl_temp', type=float, default=1.5)

parser.add_argument('--pooler_type', type=str, default='cls')

parser.add_argument('--transform', action='store_true', default=False)

parser.add_argument('--triencoder_head', type=str, default='hypernet')
parser.add_argument('--hypernet_scaler', type=int, default=1)
parser.add_argument('--hypernet_dual', action='store_true', default=False)
parser.add_argument('--hypernet_ablation', action='store_true', default=False)  # FIXME
